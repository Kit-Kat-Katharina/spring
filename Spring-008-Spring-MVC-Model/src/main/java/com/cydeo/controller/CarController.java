...
@Controller
@RequestMapping("student/car")
public class CarController {
    @RequestMapping("/info") //localhost:8080/student/car/info?make=Honda&year=2015
    ...
    @RequestMapping("/info2") //localhost:8080/student/car/info?make=Honda&year=2015
    ...
    @RequestMapping("/info/{make}/{year}")//localhost:8080/student/car/info/honda/2015
